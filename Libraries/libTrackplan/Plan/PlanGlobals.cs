...
namespace libTrackplan.Plan
{
    public static class PlanGlobals
    {
        ...
        {
            Track, Switch, Signal, Block, Stage, Sensor, Direction, Connector, Button, Label
        }
        ...
        public static readonly List<int> BlockIds = new() { 150, 151 };
        public static readonly List<int> StageIds = new() { 152 };
        ...
        public static bool IsTrackItem(int themeId)
        {
            ...
            if (StageIds.Contains(themeId)) return true;
        ...
        public static ThemeIdType GetThemeType(int themeId)
        {
            ...
            if (StageIds.Contains(themeId)) return ThemeIdType.Stage;
            ...
            if (LabelIds.Contains(themeId)) return ThemeIdType.Label;
        ...
        public static string GetThemeTypeName(int themeId)
        {
            ...
            switch (type)
            {
                ...
                case ThemeIdType.Stage: return "Stage";
                ...
                case ThemeIdType.Label: return "Label";
            }
            return "Track";
        }
